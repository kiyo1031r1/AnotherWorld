...
public class BossShortRangeAttack_RisingP : MonoBehaviour
{
    ...
    public void AttackStart()
    {
        if (!status.IsAttack)
        {
            ...
            animator.SetTrigger("RisingP");
            animator.SetFloat("MoveSpeed", 0);
        }
    }

    public void OnAttackHitDetector_RisingP()
    {
    ...
    public void AttackFinish_RisingP()
    {
        hitDetecter.gameObject.SetActive(false);
        hitDetecter.enabled = false;
